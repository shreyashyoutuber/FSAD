        ...
        <div>
            ...
            <footer style={{ position: 'relative', zIndex: 10 }}>
                <div className="footer-grid">
                    ...
                    <div className="footer-col" id="contact-info">
                        ...
                        <ul className="footer-contact-list">
                            <li><a href="bharthomevalue@gmail.com" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}><span style={{ color: 'var(--primary)' }}><Icons.Mail /></span> hello@bharathomevalue.com</a></li>
                ...
                <div className="footer-bottom">
                    <p>© 2025 BharatHome Value. All rights reserved. | <a onClick={() => setPolicyState({ open: true, activeCat: 'Privacy & Cookies' })} style={{ cursor: 'pointer', color: 'var(--primary)' }}>Privacy Policy</a> | <a onClick={() => setPolicyState({ open: true, activeCat: 'Terms of Use' })} style={{ cursor: 'pointer', color: 'var(--primary)' }}>Terms of Use</a></p>
                </div>
            </footer>
        </div>
    )
