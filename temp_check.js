        ...
        <div onClick={e => e.target === e.currentTarget && onClose()}
            ...
            <div style={{ background: 'white', borderRadius: '24px', width: '100%', maxWidth: '500px', overflow: 'hidden', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5)', animation: 'slideUp 0.3s ease' }}>
                <div style={{ background: 'linear-gradient(135deg, var(--primary), var(--primary-dark))', padding: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <button onClick={onClose} style={{ background: 'rgba(255,255,255,0.2)', border: 'none', color: 'white', width: '32px', height: '32px', borderRadius: '50%', cursor: 'pointer', fontSize: '18px', fontWeight: 700 }}>Ã—</button>
                </div>
                ...
                <div className="card" style={{ margin: 0, padding: '36px' }}>
                    ...
                    <div style={{ marginBottom: '32px' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '8px', fontSize: '12px', color: '#94a3b8', fontWeight: 600 }}>
                            <span>â‚¹50K</span><span>â‚¹50L</span>
                        </div>
                        {/* Quick amounts */}
                    ...
                    <div style={{ marginBottom: '32px' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '8px', fontSize: '12px', color: '#94a3b8', fontWeight: 600 }}>
                            <span>0%</span>
                            <span style={{ color: '#10b981', fontWeight: 700 }}>Typical: 8â€“14%</span>
                            <span>30%</span>
                        </div>
                    </div>
        ...
        <div onClick={e => e.target === e.currentTarget && onCancel()}
            ...
            <div style={{ background: 'white', borderRadius: '24px', width: '100%', maxWidth: '400px', overflow: 'hidden', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5)', animation: 'slideUp 0.3s ease' }}>
                <div style={{ padding: '32px', textAlign: 'center' }}>
                    <div style={{ width: '60px', height: '60px', background: '#fee2e2', color: '#dc2626', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '30px', margin: '0 auto 20px' }}>âš ï¸</div>
            ...
            <div style={{ background: 'white', borderRadius: '20px', width: '100%', maxWidth: '480px', height: '580px', display: 'flex', flexDirection: 'column', boxShadow: '0 30px 80px rgba(0,0,0,0.35)', overflow: 'hidden', animation: 'slideUp 0.3s ease' }}>
                ...
                <div style={{ background: 'linear-gradient(135deg, var(--primary), var(--primary-dark))', padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{ width: '40px', height: '40px', background: 'rgba(255,255,255,0.25)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px' }}>ðŸ </div>
                        <div>
                            <p style={{ color: 'white', fontWeight: 800, fontSize: '15px' }}>Negotiate with Expert</p>
                            <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '12px' }}>{requestType} Â· {requestId}</p>
                        </div>
                    </div>
                    <button onClick={onClose} style={{ background: 'rgba(255,255,255,0.2)', border: 'none', color: 'white', width: '32px', height: '32px', borderRadius: '50%', cursor: 'pointer', fontSize: '18px', fontWeight: 700 }}>Ã—</button>
                </div>
                        ...
                        <div key={i} style={{ display: 'flex', justifyContent: m.sender === 'user' ? 'flex-end' : m.sender === 'system' ? 'center' : 'flex-start' }}>
                            {m.sender === 'system' ? (
                                <div style={{ maxWidth: '88%', background: '#fff3e0', border: '1px solid #ffcc80', borderRadius: '12px', padding: '12px 18px', textAlign: 'center' }}>
                                    ...
                                    <p style={{ fontSize: '10px', color: '#d97706', marginTop: '6px' }}>Auto-generated Â· {fmt(m.time)}</p>
                                </div>
                            ) : (
        ...
        <div
            ...
            <div style={{ position: 'absolute', top: 0, left: 0, right: 0, padding: '20px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'linear-gradient(rgba(0,0,0,0.6), transparent)' }}>
                <div>
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '13px', marginTop: '2px' }}>{index + 1} of {total} Â· Design Reference</p>
                </div>
...
// // export removedremoved function UserDashboard() {
        ...
        <div className="dashboard-layout">
            ...
            <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`} style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                ...
                <div className="sidebar-footer" style={{ flexShrink: 0, borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '8px' }}>
                    <div className="sidebar-link" onClick={() => setShowExitConfirm(true)}>â† Back to Home</div>
                </div>
            </aside>
            ...
            <div className="dashboard-wrapper">
                <header className="dashboard-header">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        <button onClick={() => setSidebarOpen(!sidebarOpen)} style={{ display: 'none', background: 'none', border: 'none', cursor: 'pointer', fontSize: '24px' }} className="mobile-menu-btn">â˜°</button>
                                        ...
                                        {unreadChats > 0 ? (
                                            estimates.filter(r => {
                                                ...
                                                <div key={r.id} onClick={() => { setView('recommendations'); setChatReq({ id: r.id, type: r.type }); setShowNotifications(false) }} style={{ padding: '16px', borderBottom: '1px solid #f1f5f9', cursor: 'pointer', transition: '0.2s' }} onMouseEnter={e => e.currentTarget.style.background = '#f8fafc'} onMouseLeave={e => e.currentTarget.style.background = 'transparent'}>
                                                    <div style={{ display: 'flex', gap: '12px' }}>
                                                        <div style={{ width: '40px', height: '40px', background: '#fff7ed', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', flexShrink: 0 }}>ðŸ’¬</div>
                                                        <div>
                                                            <p style={{ fontSize: '13px', fontWeight: 700, color: '#1a1a1a', margin: '0 0 4px' }}>Expert replied to your request</p>
                                                            <p style={{ fontSize: '12px', color: '#64748b', margin: 0 }}>{r.type} Â· {r.id}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ))
                            ...
                            <div className="animate-fadeIn">
                                ...
                                {activeProperty ? (
                                    <>
                                        ...
                                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginBottom: '32px' }}>
                                            {[
                                                { label: 'Potential Value Increase', value: `+â‚¹${(displayValueIncrease / 100000).toFixed(2)}L`, sub: activeRecsCount > 0 ? 'With all recommendations' : 'Initial AI Projection', color: '#3b82f6', icon: <Icons.Dashboard /> },
                                                { label: 'Total Investment', value: `â‚¹${(displayInvestment / 100000).toFixed(2)}L`, sub: activeRecsCount > 0 ? 'Estimated renovation cost' : 'Initial AI Estimate', color: '#f59e0b', icon: <Icons.Estimator /> },
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px,1fr))', gap: '20px' }}>
                                    {estimates.map((est, i) => (
                                        <div key={i} className={`card animate-slideUp stagger-${(i % 5) + 1} hover-lift`} style={{ margin: 0, position: 'relative' }}>
                                            ...
                                            <p style={{ fontSize: '24px', fontWeight: 800, color: 'var(--primary)', margin: '12px 0' }}>â‚¹{est.cost?.toLocaleString('en-IN')}</p>
                                ...
                                {[
                                    ...
                                    <div key={i} className={`card animate-slideUp stagger-${(i % 5) + 1}`} style={{ margin: 0, textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '24px' }}>
                                            {c.features.map(f => <span key={f} style={{ fontSize: '13px', color: 'var(--muted)' }}>âœ“ {f}</span>)}
                                        </div>
                                        <button onClick={() => navigate(c.link)} className="btn-submit button-press">Calculate Now â†’</button>
                                    </div>
                                ))}
                            </div>
                        </div>
                            ...
                            <div className="animate-fadeIn">
                                ...
                                {myRequests.length === 0 ? (
                                    <div className="card hover-lift" style={{ textAlign: 'center', padding: '70px 40px' }}>
                                        ...
                                        <button onClick={() => setView('new-estimator')} className="btn-submit button-press" style={{ width: 'auto', padding: '12px 28px' }}>Submit an Estimate â†’</button>
                                    </div>
                                ) : (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                                                ...
                                                <div key={req.id} className={`card animate-slideUp stagger-${(i % 5) + 1}`} style={{ margin: 0, borderLeft: '4px solid ' + (isResponded ? '#10b981' : '#f59e0b'), borderRadius: '16px', padding: '28px' }}>
                                                    ...
                                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px', marginBottom: '24px' }}>
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p style={{ color: 'var(--muted)', fontSize: '13px' }}>Request {req.id} Â· {isResponded ? `Quote received on ${res.responseDate}` : 'Processing by our experts'}</p>
                                                            </div>
                                                        </div>
                                                        <span style={{
                                                    ...
                                                    {req.propertyPhotos && req.propertyPhotos.length > 0 && (
                                                        <div style={{ marginBottom: '24px', background: '#fdf6ee', borderRadius: '12px', padding: '16px', border: '1px solid #fbd38d' }}>
                                                            <h4 style={{ fontSize: '13px', fontWeight: 700, color: '#b45309', textTransform: 'uppercase', marginBottom: '12px' }}>ðŸ—ï¸ Your Property Photos ({req.propertyPhotos.length})</h4>
                                                        ...
                                                        <>
                                                            ...
                                                            {res.images && res.images.length > 0 && (
                                                                <div style={{ marginBottom: '20px' }}>
                                                                    <h4 style={{ fontSize: '14px', fontWeight: 700, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '12px' }}>ðŸ–¼ï¸ Design References ({res.images.length})</h4>
                                                                        ...
                                                                        {res.images.map((img, idx) => (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(transparent 50%, rgba(0,0,0,0.5))', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', padding: '10px' }}>
                                                                                    ...
                                                                                    <span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '16px' }}>ðŸ”</span>
                                                                                </div>
                                                                            </div>
                                                                        ))}
                                                                    </div>
                                                    ...
                                                    <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                                                        ...
                                                        {isResponded && (
                                                            <>
                                                                <button
                                                                    onClick={() => { navigator.clipboard?.writeText(`Quote: â‚¹${Number(res.quote || 0).toLocaleString('en-IN')} | Timeline: ${res.timeline} | Warranty: ${res.warranty}`); alert('Quote details copied!') }}
                                                                    className="button-press"
                                                                    style={{
                                                                    ...
                                                                    onClick={() => {
                                                                        ...
                                                                        <html>
                                                                            ...
                                                                            <body>
                                                                                ...
                                                                                <div class="grid">
                                                                                    <div class="box"><div class="label">Expert Quote</div><div class="value">â‚¹${Number(res.quote || 0).toLocaleString('en-IN')}</div></div>
                    ...
                    {view === 'referral' && (
                        <div className="animate-fadeIn" style={{ maxWidth: '900px', margin: '0 auto' }}>
                            <div className="card" style={{ background: 'linear-gradient(135deg, #1e293b, #0f172a)', color: 'white', padding: '48px', textAlign: 'center', marginBottom: '32px' }}>
                                ...
                                <h2 style={{ fontSize: '36px', fontWeight: 800, marginBottom: '16px' }}>Refer a Friend, Get â‚¹2,000</h2>
                            ...
                            <div className="card" style={{ margin: 0 }}>
                                <form onSubmit={async (e) => {
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                        ...
                                        <div className="form-group"><label>Market Value (â‚¹)</label><input name="marketValue" type="number" placeholder="e.g., 5000000" required /></div>
                                        <div className="form-group"><label>Improvement Budget (â‚¹)</label><input name="improvementBudget" type="number" placeholder="e.g., 500000" required /></div>
                                    </div>
                                        ...
                                        <div style={{ height: '200px', position: 'relative' }}>
                                            ...
                                            {c.verified && (
                                                <div style={{ position: 'absolute', top: '16px', right: '16px', background: '#10b981', color: 'white', padding: '6px 14px', borderRadius: '30px', fontSize: '11px', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '6px', boxShadow: '0 4px 10px rgba(16,185,129,0.4)' }}>
                                                    <span style={{ fontSize: '14px' }}>âœ“</span> VERIFIED
                                                </div>
                                            )}
                                        ...
                                        <div style={{ padding: '24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px' }}>
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', background: '#fff7ed', padding: '4px 8px', borderRadius: '8px' }}>
                                                    <span style={{ color: '#e67e22', fontWeight: 800 }}>â˜…</span>
                                            ...
                                            <p style={{ color: 'var(--muted)', fontSize: '14px', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                                <span style={{ fontSize: '16px' }}>ðŸ“</span> {c.location}
                                            </p>
                                        ...
                                        <div style={{ height: '300px', width: '100%', position: 'relative' }}>
                                            ...
                                            <div style={{ position: 'absolute', bottom: '32px', left: '40px', color: 'white' }}>
                                                ...
                                                <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                                                    ...
                                                    <span style={{ fontSize: '15px', fontWeight: 600 }}>ðŸ“ {selectedContractor.location}</span>
                                                    <span style={{ fontSize: '15px', fontWeight: 600 }}>â˜… {selectedContractor.rating} ({selectedContractor.reviews} reviews)</span>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div onClick={() => setShowReviewModal(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(15, 23, 42, 0.7)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 3000, padding: '20px' }}>
                    <div onClick={e => e.stopPropagation()} className="animate-scaleIn" style={{ background: 'white', borderRadius: '24px', width: '100%', maxWidth: '500px', padding: '40px', textAlign: 'center', boxShadow: '0 40px 100px rgba(0,0,0,0.3)' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', marginBottom: '32px' }}>
                            {[1, 2, 3, 4, 5].map(s => (
                                <button key={s} onClick={() => setReviewRating(s)} style={{ background: 'none', border: 'none', fontSize: '32px', cursor: 'pointer', transition: '0.2s', transform: reviewRating >= s ? 'scale(1.2)' : 'scale(1)', opacity: reviewRating >= s ? 1 : 0.3 }}>â­</button>
                            ))}
                        </div>
